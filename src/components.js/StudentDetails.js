...
const res=await axios.delete(API+`/studentdetails/${id}`)
if(res){
    alert(`${student.firstName+" "+student.lastName} user was deleted`)
  ...
  const  getAllStudentDetails=async()=>{
    try {
        const res=await axios.get(API+"/studentdetails")
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                            ...
                            {/* <!-- Begin Page Content --> */}
                            <div  className='text-center'><h2 >Student Details</h2>
                            <Link to={"/create-student"}><span className='btn btn-secondary'> Create Student</span></Link></div>               
<div className='hole-form'>
 ...
 <Link to={`/edit-studentdetails/${student.id}`}><td>
    <button className='btn btn-primary'>Edit</button></td>
 </Link>
 <td><button onClick={()=>deleteStudent(student,student.id)} className='btn btn-danger'>Delete</button></td>
</tr>
