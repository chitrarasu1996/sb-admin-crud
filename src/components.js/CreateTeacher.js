...
const CreateTeacher = () => {
    ...
    const createTeacher=async(e)=>{
        e.preventDefault()
        const res=await axios.post(teacherAPI+"teacherdetails",{firstName:teacherDetails.firstName,lastName:teacherDetails.lastName})
  if(res.data){
    alert(`${res.data.firstName+res.data.lastName} was successfully created`)
  navigate("/teacher")
}
    }
  ...
  <div className='d-flex m-auto  justify-content-center'>
      ...
      <div >
      <Form className='border p-3 ' onSubmit={createTeacher}>
        <h3 className='mb-3'>Create Teacher</h3>
    <FormGroup>
      <Label
        for="firstName"
        hidden
