...
import { API, teacherAPI } from '../service/API';
...
const TeacherDetails = () => {
  ...
  const deleteTeacher=async(teacher)=>{
    ...
    const res=await axios.delete(teacherAPI+`/teacherdetails/${teacher.id}`)
 if(res){
  alert(`${teacher.firstName+teacher.lastName} was deleted successfully`)
  getTeacherDetails()
 }
  }
useEffect(()=>{
...
const getTeacherDetails=async()=>{
  const res=await axios.get(teacherAPI+"teacherdetails")
                ...
                <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                        ...
                        <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                            ...
                            {/* <!-- Begin Page Content --> */}
                            <div  className='text-center'><h2 >Teacher Details</h2>
                            <Link to={"/create-teacher"}><span className='btn btn-secondary'> Create Teacher</span></Link></div>               
<div className='hole-form'>
 ...
 <Link to={`/edit-teacherdetails/${teacher.id}`}><td>
    <button className='btn btn-primary'>Edit</button></td>
 </Link>
 <td>
  <button className='btn btn-danger' onClick={()=>deleteTeacher(teacher)}>Delete</button></td>
</tr>
