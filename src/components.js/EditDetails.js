...
const EditDetails = () => {
  ...
  const [perticularStudentId,setperticularStudentId]=useState("")
  const [perticularStudent,setParticularDetails]=useState({
    firstName:"",
    lastName:""
  })
   useEffect(()=>{
getStudentDetails()
   ...
   const getStudentDetails=async()=>{
    const res=await axios.get(API+`/studentdetails/${studentId}`)
  
    setParticularDetails({...perticularStudent,
...
const res=await axios.put(API+`/studentdetails/${studentId}`,{firstName:perticularStudent.firstName,lastName:perticularStudent.lastName})
if(res.data){
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                    ...
                    {/* <!-- Begin Page Content --> */}
                    <div  className='text-center mb-5'><h2 >Edit student</h2>
                 
                    </div>               
                      <div className=' d-flex m-auto justify-content-center'>
   <form onSubmit={submitted}  className='border p-5'> <div class="mb-3">
  <label for="exampleInputEmail1" class="form-label">First Name</label>
  <input onChange={(e)=>setParticularDetails({...perticularStudent,firstName:e.target.value})} value={perticularStudent.firstName}  type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>    
</div>
 <div class="mb-3">
  <label for="exampleInputPassword1" class="form-label">Lastname</label>
  <input onChange={(e)=>setParticularDetails({...perticularStudent,lastName:e.target.value})} value={perticularStudent.lastName}  type="text" class="form-control" id="exampleInputPassword1"/>
 </div>
