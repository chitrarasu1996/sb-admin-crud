...
<li className="nav-item">
    ...
    <div id="collapsePages" className="collapse" aria-labelledby="headingPages" data-parent="#accordionSidebar">
        <div className="bg-white py-2 collapse-inner rounded">
            ...
            <Link to={"/registor"} className="collapse-item">Register</Link>                   <Link to={"/forgot"} className="collapse-item">Forgot Password</Link> 
...
<p class="mb-4 ">Bootstrap's default utility classes can be found on the official <Link  className="text-decoration-none me-1"   to={"https://getbootstrap.com/docs"} > Bootstrap Documentation</Link>
                          page. The custom utilities
