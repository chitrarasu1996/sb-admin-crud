...
const navigate=useNavigate()
    ...
    const createStudent=async(e)=>{
        e.preventDefault()
        const res=await axios.post(API+"/studentdetails",{firstName:studentDetails.firstName,lastName:studentDetails.lastName})
    if(res){
        alert("student succefully created")
        navigate("/student")
    }
    }
    ...
    <div className='d-flex m-auto   justify-content-center'>
        ...
        <Form onSubmit={createStudent}>
          <h3 className='mb-5'>Create Student</h3>
      <FormGroup>
        <Label
          for="firstName"
          hidden
