...
const [perticularTeacher,setParticularTeacher]=useState({
firstName:"",
lastName:""
})
useEffect(()=>{
...
const submitted=async(e)=>{
    ...
    const res=await axios.put(teacherAPI+`teacherdetails/${teacherId}`,{firstName:perticularTeacher.firstName,lastName:perticularTeacher.lastName})
    if(res.data){
        alert("teacher was created successfully")
        navigate("/teacher")
    }
       }

const getTeacherDetails=async()=>{
    const res=await axios.get(teacherAPI+`teacherdetails/${teacherId}`)
    if(res.data){
setParticularTeacher({...perticularTeacher,firstName:res.data.firstName,lastName:res.data.lastName})
    }
}
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities"
            ...
            <div class="dropdown-menu dropdown-menu-right shadow animated--grow-in"
                ...
                <a class="dropdown-item" href="#" data-toggle="modal" data-target="#logoutModal">
                    ...
                    {/* <!-- Begin Page Content --> */}
                    <div  className='text-center mb-5'><h2 >Edit teacher</h2>
                 
                    </div>               
                    <div className=' d-flex m-auto justify-content-center'>
        <form onSubmit={submitted} className='border p-4'>
    <div class="mb-3">
      <label for="exampleInputEmail1" class="form-label">First Name</label>
      <input onChange={(e)=>setParticularTeacher({...perticularTeacher,firstName:e.target.value})} value={perticularTeacher.firstName}
       type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp"/>    
    </div>
    <div class="mb-3">
      <label for="exampleInputPassword1" class="form-label">Lastname</label>
      <input onChange={(e)=>setParticularTeacher({...perticularTeacher,lastName:e.target.value})} value={perticularTeacher.lastName}
